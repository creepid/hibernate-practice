 ...
 * types.
 * <p>
 * Note that this mapping type is for legacy databases that only have a single
 * numeric column to hold monetary amounts. Every <tt>MonetaryAmount</tt>
 ...
 * converted to the currency prefered by the current user (UserSession thread
 * local).
 *
