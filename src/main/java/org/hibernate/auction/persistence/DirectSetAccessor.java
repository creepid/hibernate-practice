...
public class DirectSetAccessor implements PropertyAccessor {
    ...
    public static final class DirectSetter implements Setter {
        ...
        public void set(Object o, Object o1, SessionFactoryImplementor sfi) throws HibernateException {
            ;;
        }
    ...
    public static final class BasicGetter implements Getter {
        ...
        @Override
        public Object getForInsert(Object o, Map map, SessionImplementor si) throws HibernateException {
            return o;
        }
