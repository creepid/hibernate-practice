...
/**
 * A servlet filter that disconnects and reconnects a Hibernate Session for each
 * request.
 * <p>
 * Use this filter for the <b>session-per-application-transaction</b> pattern
 * with a <i>Long Session</i>. Don't forget to demarcate application
 * transactions in your code, as described in Hibernate in Action.
 *
 * @see HibernateUtil
