 ...
 * relationship that references parent and child categories. Each Category can
 * have many Items (and an Item can be in many categories). This is a true
 * many-to-many relationship.
 * <p>
 * The optional class <tt>CategorizedItem</tt> can be used if additional
 * information has to be kept about the link between a Category and an Item. The
 * collection of <tt>items</tt> will then be mapped as a collection of dependent
 * objects in the mapping for <tt>Category</tt>.
 *
 * @see Item
 * @see CategorizedItem
...
public class Category implements Serializable, Comparable {
    ...
    public boolean equals(Object o) {
        ...
        if (created != null ? !created.equals(category.created) : category.created != null) {
            return false;
        }
