 ...
 * <p>
 * This class represents the user entity of CaveatEmptor business. The
 * associations are: a <tt>Set</tt> of <tt>Item</tt>s the user is selling, a
 * <tt>Set</tt> of <tt>Bid</tt>s the user has made, and an <tt>Address</tt>
 * component. Also a <tt>Set</tt> of
 * <tt>BuyNow</tt>s, that is, immediate buys made for an item.
 * <p>
 * The <tt>billingDetails</tt> are used to calculate and bill the user for his
 * activities on our system. The <tt>username</tt>
 * and <tt>password</tt> are used as login credentials. The
 * <tt>ranking</tt> is a number that is increased by each successful
 * transaction, but may also be manually increased (or decreased) by the system
 * administrators.
 *
 *
...
public class User implements Serializable, Comparable {
     ...
     * <p>
     * This method checks if there is only one billing method in the set, then
     ...
     * <p>
     * This method checks if the removed is the default element, and will throw
     * a BusinessException if there is more than one left to chose from. This
     * might actually not be the best way to handle this situation.
     *
     * @param billingDetails
